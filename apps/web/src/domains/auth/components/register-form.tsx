...
export function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validation.isValid) {
      ...
      validation.errors.forEach((err: { field: string; message: string | undefined; }) => {
        const field = err.field as "name" | "email" | "password" | "confirmPassword";
        if (
          field === "name" ||
          field === "email" ||
          field === "password" ||
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (
      ...
      const fieldName = name as "name" | "email" | "password" | "confirmPassword";
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 ${touched.name && fieldErrors.name
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 pr-10 ${touched.confirmPassword && fieldErrors.confirmPassword
                  ? "border-red-500 focus-visible:ring-red-500"
                  : ""
                  }`}
                required
